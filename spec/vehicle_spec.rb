...
describe(Vehicle) do
  ...
  describe("#model") do
    it("returns the model of the vehicles") do
      test_vehicle = Vehicle.new("Toyota", "Prius", 2000, "blue", "4L", "4")
  ...
  describe(".find") do
    it("returns a vehicle by its id number") do
      test_vehicle = Vehicle.new("Toyota", "Prius", 2000, "blue", "4L", "4")
      test_vehicle.save()
      test_vehicle2 = Vehicle.new("Toyota", "Corolla", 1999, "blue", "4L", "4")
      test_vehicle2.save()
  ...
  describe("#engine_size") do
    it("returns the engine size of the vehicle") do
      test_vehicle = Vehicle.new("Toyota", "Prius", 2000, "blue", "4L", "4")
  ...
  describe("#number_of_doors") do
    it("returns the number of doors of the vehicle") do
      test_vehicle = Vehicle.new("Toyota", "Prius", 2000, "blue", "4L", "4")
